...
class Sea:
    ...
    def __str__(self) -> str:
        ...
        return 'o' if self.hit_status==True else '.'
...
class Square:
    ...
    def set_ship_part(self, ship_part: 'ShipPart') -> None:
        ...
        if self.content is not None:
            raise ValueError("Ship part already added, it cannot be changed!")
    ...
    def __str__(self) -> str:
        ...
        '''
        return self.contentChar
    
    def __repr__(self) -> str:
        '''Representation of the square.'''
        return f'Square(contentChar={self.contentChar},hit_status={self.hit_status},content={self.content})'
